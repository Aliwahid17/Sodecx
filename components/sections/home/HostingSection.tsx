                ...
                <div className="flex flex-col lg:flex-row items-center justify-around lg:gap-3 xl:gap-5 h-full">
                    ...
                    <div className="flex flex-col w-full gap-5 lg:gap-9 " >
                        <div className="text-5xl font-semibold flex w-full justify-between" >
                            ...
                            <Image src={'../../assets/icons/home/lines.svg'} alt="Vector Line" width={110} height={18} className="animation animate" />
                        </div>
                        <p className="animation animate">{t('description')}</p>
                        <div className="flex justify-between items-center " >
                            <Button serverActions={contactForm} className="animation animate" title={currentLocale === 'en' ? "Contact Us" : 'Contact'}  />
                            <svg xmlns="http://www.w3.org/2000/svg" width="56" height="14" viewBox="0 0 56 14" fill="none" className="animation-reverse animate">
