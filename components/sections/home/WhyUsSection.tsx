                ...
                <div className="flex flex-col lg:flex-row-reverse items-center justify-around lg:gap-3 xl:gap-5 h-full">
                    <div className="flex w-full justify-around">
                        <div className="hidden sm:flex flex-col justify-between">
                            <svg className="animation animate" xmlns="http://www.w3.org/2000/svg" width="70" height="18" viewBox="0 0 70 18" fill="none">
                            ...
                            <svg className="animation-bottom animate" xmlns="http://www.w3.org/2000/svg" width="19" height="79" viewBox="0 0 19 79" fill="none">
                    ...
                    <div className="flex flex-col w-full gap-5 lg:gap-9" >
                        <div className="text-5xl font-semibold flex w-full justify-between" >
                            ...
                            <Image src={'../../assets/decors/Vector.svg'} alt="Vector Line" className="animation animate" width={110} height={18} />
                        </div>
                        <p className="animation animate">{t('description')}</p>
                        <div className="flex flex-col gap-2 items-start animation animate">
                            {whyUsPoints.map((point, index) => (
                                <div key={index} className="flex items-start gap-3 font-medium animation animate">
